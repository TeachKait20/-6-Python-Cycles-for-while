...
Напишите программу, которая запрашивает у пользователя число от 1 до 9 и выводит таблицу умножения для этого числа. Если пользователь вводит число вне указанного диапазона, программа должна попросить ввести число заново. Используйте локальный счётчик для отслеживания итераций.
