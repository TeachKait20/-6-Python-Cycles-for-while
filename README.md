...
Напишите программу, которая запрашивает у пользователя число от 1 до 9 и выводит таблицу умножения для этого числа. Если пользователь вводит число вне указанного диапазона, программа должна попросить ввести число заново. Используйте локальный счётчик для отслеживания итераций. *Можно использовать два цикла в программе.* 

Пример выходных данных: <br>
![image](https://github.com/user-attachments/assets/09b53104-95c1-4dce-8f48-1cc07614e5a5)

**Задание 10**

Программа задаёт пользователю загадку, у него есть три попытки чтобы её разгадать. Выводите сколько попыток осталось у пользователя в случае неправильного ответа. Используйте локальный счётчик и цикл `while`.

Пример выходных данных: <br>
![image](https://github.com/user-attachments/assets/bda36a80-58a3-471c-a978-d53b54da990a)
